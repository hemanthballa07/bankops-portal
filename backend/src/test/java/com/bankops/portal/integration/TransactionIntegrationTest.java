...
class TransactionIntegrationTest {
    ...
    void testCreateTransaction_ReturnsCorrelationId() throws Exception {
        ...
        // When
        String response = mockMvc.perform(post("/api/accounts/{accountId}/transactions", account.getId())
    ...
    void testCreateTransaction_UpdatesAccountBalance() throws Exception {
        ...
        // When
        mockMvc.perform(post("/api/accounts/{accountId}/transactions", account.getId())
                        .contentType(MediaType.APPLICATION_JSON)
                        .content(objectMapper.writeValueAsString(request)))
                .andExpect(status().isCreated());
